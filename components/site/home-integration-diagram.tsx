  ...
  return (
    <div
      className={[
        ...
        filled
          ? "border border-white/6 bg-white text-primary shadow-[0_30px_80px_-40px_rgba(255,255,255,0.3)]"
    ...
    >
      <div className={compact ? "max-w-[9.5rem] px-4" : "max-w-[8.5rem] px-4"}>
        ...
        <p className={filled ? "mt-3 text-sm font-semibold leading-6 text-primary/80 sm:text-base" : "mt-3 text-sm leading-6 text-white/68 sm:text-base"}>
          {description}
        </p>
      </div>
    </div>
    ...
    <section className="jeyul-home-section relative isolate min-h-[100svh] overflow-hidden bg-[#11151b] text-white lg:h-[100svh] lg:snap-start">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col px-4 py-16 sm:px-6 lg:h-full lg:px-8 lg:py-20">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="pt-2">
            <Button asChild className="h-12 rounded-none bg-white px-5 text-[11px] font-semibold uppercase tracking-[0.18em] text-primary hover:bg-white/92">
              <Link href="/contact">
                통합 건축 솔루션 문의하기
        ...
        <div className="relative mt-16 flex flex-1 items-center lg:mt-10">
          <div className="relative flex w-full flex-col items-center gap-8 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
            ...
            <div className="relative z-10 lg:ml-10">
              <div
                aria-hidden="true"
                className="absolute right-full top-1/2 hidden h-px w-96 -translate-y-1/2 bg-white/24 lg:block"
              />
              <Circle title="통합 건축 솔루션" description="시간 단축, 비용 절감" compact variant="filled" />
            </div>
          </div>
        </div>
      </div>
